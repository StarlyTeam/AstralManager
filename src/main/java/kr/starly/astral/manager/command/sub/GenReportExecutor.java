...
import kr.starly.astral.manager.collector.PluginDataCollector;
import kr.starly.astral.manager.collector.ServerInfoCollector;
import kr.starly.astral.manager.collector.StarlyPluginConfigCollector;
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        ...
        Thread thread = new Thread(() -> {
            ...
            try {
                ...
                sender.sendMessage(MessageContext.PREFIX + "§c서버 정보를 수집하는 도중 오류가 발생했습니다.");
            }
            ...
            try {
                ...
                sender.sendMessage(MessageContext.PREFIX + "§c서버 설정을 수집하는 도중 오류가 발생했습니다.");
            }
            ...
            try {
                ...
                sender.sendMessage(MessageContext.PREFIX + "§c서버 로그를 수집하는 도중 오류가 발생했습니다.");
            }
            ...
            try {
                ...
                sender.sendMessage(MessageContext.PREFIX + "§c플러그인 정보를 수집하는 도중 오류가 발생했습니다.");
            }
            ...
            try {
                ...
                sender.sendMessage(MessageContext.PREFIX + "§cLuckPerms 정보를 수집하는 도중 오류가 발생했습니다.");
            }
            ...
            try {
                ...
                sender.sendMessage(MessageContext.PREFIX + "§c스탈리 플러그인 콘피그 정보를 수집하는 도중 오류가 발생했습니다.");
            }
            ...
            try {
                ...
                sender.sendMessage(MessageContext.PREFIX + "§c보고서를 마무리하는 도중 오류가 발생했습니다.");
                return;
            }

            sender.sendMessage(MessageContext.PREFIX);
            sender.sendMessage(MessageContext.PREFIX + "§e❕ §a보고서 생성이 완료되었습니다.");
            sender.sendMessage(MessageContext.PREFIX + "§e❕ §a경로§f: " + resultFile.getPath());
            sender.sendMessage(MessageContext.PREFIX + "§e❕ §c주의: 해당 보고서에는 다음과 같은 내용이 포함됩니다.");
            sender.sendMessage(MessageContext.PREFIX + "§e❕ §c[§e서버 정보§7, §e서버 속성§7, §e최신 로그§7, §e플러그인 목록/정보§7, §eLuckPerms 설정§7, §e스탈리 플러그인의 DataFolder§c]");
            sender.sendMessage(MessageContext.PREFIX + "§e❕ §c해당 보고서 파일은 중요한 정보를 포함하고 있습니다.");
            sender.sendMessage(MessageContext.PREFIX + "§e❕ §c파일 제공을 요청 받으셨더라도, 제공하지 않으실 수 있습니다.");
            sender.sendMessage(MessageContext.PREFIX);
        });
